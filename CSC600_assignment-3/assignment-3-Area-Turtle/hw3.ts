...
export function newStrangeNumber(): StrangeNumber {
    // TODO: Implement me
    //throw Error("TODO");
    let num = new StrangeNumberClass();
    let mycount = num.count
...
//const
    return {
        count: mycount,
        isEven: ((mycount) => isEven(mycount)),
        isOdd: ((mycount) => isOdd(mycount))
  }
}
...
export class ArrJSONValue implements JSONValue {
    ...
    public allPathsSatisfyingPredicate(predicate: (authority: string) => boolean): string[] {
        // TODO: Implement me
        //throw Error("TODO");
        const arr = this.arr as JSONValue[];
        return arr.map((x: JSONValue) => this.allPathsSatisfyingPredicate(predicate)).reduce((acc, x) => acc.concat(x));
    }
...
export class ObjJSONValue implements JSONValue {
    ...
    public allPathsSatisfyingPredicate(predicate: (authority: string) => boolean): string[] {
        // TODO: Implement me
        //
        const entry = this.obj as { authority: string, links: JSONValue[] };
        const acc = [];
        ...
        return acc.concat(entry.links.map((x: JSONValue) => this.allPathsSatisfyingPredicate(predicate))
